...
while True:
    ...
    if opcao =='A':
        ...
        if len(cpf) == 11: 
            ...
            print(f'ATENÇÃO, o CPF deve conter 11 dígitos.')
        
        
        #PARTE QUE FALTA
        '''elif cpf is not int:
            print('ATENÇÃO! Por favor, informe somente valores numéricos.')       
        
        else:
            transferir = float(input('Informe o valor que deseja transferir: R$ '))
            saldo -= transferir
            print(f'Você transferiu R$ {transferir:.2f} para o CPF {cpf}. end=''. Seu saldo agora é de R$ {saldo:.2f}')  '''          
